            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {logs.map(log => (
                <tr key={log.id} className="hover:bg-gray-50">
                  <td className="px-4 py-2 whitespace-nowrap text-sm font-medium text-gray-900">{log.line}</td>
                  <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-500">{log.valueStream || '-'}</td>
                  <td className="px-4 py-2 whitespace-nowrap text-sm text-center text-gray-900">{log.operators}</td>
                  <td className="px-4 py-2 whitespace-nowrap text-sm text-center text-gray-900">{log.supervisors}</td>
                  <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-500">{log.month}</td>
